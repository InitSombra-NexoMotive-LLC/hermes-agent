...
def test_numeric_telegram_identity_is_canonicalized_without_broadening_match(tmp_path):
 r=WorkerSessionRegistry(tmp_path/'s.db');c=r.start('nvidia-control','CONTROL_PLANE','123')
 r.consume('nvidia-control',c,123,'fixture-session')
 assert r.resolve('nvidia-control')=='fixture-session'
